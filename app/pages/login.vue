...
<template>
  <div>
    ...
    <section class="mx-auto w-full max-w-2xl px-6 py-12 md:px-14">
      ...
      <h1 class="mt-3 font-serif text-5xl leading-tight font-bold text-stone-900">Sign in to continue your roadmap.</h1>
      <p class="mt-4 text-stone-600">Your onboarding profile, execution steps, and progress are stored on your account.
      </p>
